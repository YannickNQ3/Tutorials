...
def getWheather():
    try:
        ...
        #wheater
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=79a64d77763db5c72f9176d78f6cfee4"
...
myimage_icon = Button(image= Search_icon, borderwidth=0, cursor="hand2", bg="#404040", command=getWheather)
...
clock = Label(root, font=("Helvetic", 20))
